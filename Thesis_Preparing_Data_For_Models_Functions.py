...
def Data_Preprocessing_Pipeline_4_PyG_GNN_Models( preprocess_training_or_test_data, numerical_features_to_scale, categorical_features = None, features_to_drop = ["BallPossesion", "Section", "Match_Minute_Clock", "Match_Seconds_Clock"], target_variable = ["Will_Be_a_Goal"] ):
    ...
    Agnostic_PyG_GNN_Model_DataFrame_Data_Folder = f"Agnostic (Simple) GNN Model/PyG DataFrame-Format Data/"
    
    File_Name_Prefix = "Augmented_Training" if preprocess_training_or_test_data == "training" else "Test"
    
    Shots_On_1_Same_Target_Goal_df = pd.read_parquet( f"{Agnostic_PyG_GNN_Model_DataFrame_Data_Folder}{File_Name_Prefix}_Shots_Frames_On_1_Same_Target_Goal_4_All_Models.parquet",
                                                      engine = "auto" )
    ...
    Preprocessed_Shots_On_1_Same_Target_Goal_df.to_parquet(f"{Agnostic_PyG_GNN_Model_DataFrame_Data_Folder}{File_Name_Prefix}_Shots_Frames_On_1_Same_Target_Goal_4_All_Models-Preprocessed.parquet", engine = "auto")
...
def Read_Preprocessed_Tracking_Data_4_PyG_GNN_Models( training_or_test_data ):
    ...
    preprocessed_shots_on_1_same_target_goal_df = pd.read_parquet(f"{Agnostic_PyG_GNN_Model_DataFrame_Data_Folder}{File_Name_Prefix}_Shots_Frames_On_1_Same_Target_Goal_4_All_Models-Preprocessed.parquet", engine = "auto")
